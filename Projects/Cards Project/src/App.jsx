  ...
  return (
    <div className='parent'>
      {jobOpenings.map(function (val, idx) {
        return <div key={idx}>
          <Card logo={val.brandLogo} companyName={val.companyName} datePosted={val.datePosted}
            role={val.post} tag1={val.tag1} tag2={val.tag2} pay={val.pay} location={val.location} />
        </div>
      })}
